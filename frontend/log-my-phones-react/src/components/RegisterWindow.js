                ...
                <Grid item xs={12} sm={8} md={5}>
                    ...
                    >
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
                            ...
                            <Snackbar open={openPwValidationAlert} autoHideDuration={6000} onClose={handleClosePwAlert}>
                                <Alert onClose={handleClosePwAlert} severity="error" sx={{ width: '100%' }}>
                                    Passwords don't match. Please try again!
                                </Alert>
                            </Snackbar>
                            <Snackbar open={openRegistrationSuccess} autoHideDuration={6000} onClose={handleCloseRegistrationSuccess}>
                                <Alert onClose={handleCloseRegistrationSuccess} severity="success" sx={{ width: '100%' }}>
